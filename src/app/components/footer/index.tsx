   ...
   bg-gray-800/70`}
    >
      <div className={`flex items-center gap-4 font-bold`}>
        <Image src={emailIcon} alt={"email"} className={`max-w-[30px]`} />
        <div>Brianyuen2@gmail.com</div>
      </div>
      <a
        className={`flex items-center gap-4 pt-4 font-bold`}
        href={"https://www.instagram.com/02exxy/"}
        target={"_blank"}
      >
        <InstagramIcon />
        <div>@O2exxy</div>
